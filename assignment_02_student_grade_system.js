...
// Function to calculate and return letter grade based on score
function getGrade(score) {
    // Return null if score is out of valid range (0 - 100)
...
function main() {
    var score = readline.questionInt("Enter student score (0-100): ");
